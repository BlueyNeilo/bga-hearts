 ...
 * particular, you can set here the values of variables elements defined in heartsblueinyellow_heartsblueinyellow.tpl (elements
    ...
    protected function getGameName()
    {
  	...
  	{		
        ...
        */
        ...
        $this->page->begin_block( "heartsblueinyellow_heartsblueinyellow", "myblock" );
